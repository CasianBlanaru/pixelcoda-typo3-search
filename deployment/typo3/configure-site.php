...
function createDemoPages(PDO $pdo): void
{
    ...
    $pageDefinitions = [
        ...
        ['title' => 'Autocomplete Suche', 'slug' => '/search-autocomplete', 'header' => 'Autocomplete und Suggestions', 'body' => 'Suchvorschlaege helfen Besuchern, TYPO3 Inhalte schneller zu finden. Die Demo-Daten verknuepfen Seiten und Inhaltselemente mit stabilen Ergebnislinks.', 'ctype' => 'textmedia'],
        ['title' => 'Pagination Suche', 'slug' => '/search-pagination', 'header' => 'Pagination und Performance', 'body' => 'Die Such-API liefert kleine Ergebnis-Sets mit Seiteninformationen. Das reduziert Payloads und haelt Core Web Vitals stabil.', 'ctype' => 'textmedia'],
        ['title' => 'Headless API', 'slug' => '/headless-api', 'header' => 'Headless JSON Output', 'body' => 'Pixelcoda Search stellt stabile JSON-Daten fuer React, Vue, Next.js und klassische TYPO3 Frontends bereit.', 'ctype' => 'textmedia'],
        ['title' => 'BITV Accessibility', 'slug' => '/bitv-accessibility', 'header' => 'BITV und Accessibility', 'body' => 'Die Suchoberflaeche unterstuetzt Tastaturbedienung, sichtbare Fokuszustaende, reduzierte Bewegung und semantische Trefferlisten.', 'ctype' => 'textmedia'],
        ['title' => 'Railway Demo', 'slug' => '/railway-demo', 'header' => 'Railway TYPO3 Demo', 'body' => 'Diese Testumgebung startet TYPO3, Search API, Frontend Editing und GSAP Animationen gemeinsam fuer Redakteur-Tests.', 'ctype' => 'textmedia'],
